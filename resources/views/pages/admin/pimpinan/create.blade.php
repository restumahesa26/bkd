        ...
        <form action="{{ route('data-pimpinan.store') }}" method="POST">
            ...
            <div class="row">
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control" value="{{ old('nama') }}" placeholder="Masukkan Nama.." required>
                </div>
                <div class="form-group col-lg-6">
                    <label for="nip">NIP</label>
                    <input type="text" name="nip" id="nip" class="form-control" value="{{ old('nip') }}" placeholder="Masukkan NIP.." required>
                </div>
                <div class="form-group col-lg-6">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" name="tahun_akademik" id="tahun_akademik" class="form-control" value="{{ old('tahun_akademik') }}" placeholder="Masukkan Tahun Akademik.." required>
                </div>
            </div>
